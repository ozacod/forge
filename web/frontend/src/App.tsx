            ...
            <div className="flex items-center gap-3">
              ...
              {activeTab === 'configure' && (
                <button
                  ...
                  className="bg-cyan-500 hover:bg-cyan-400 text-black px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2 transition-colors"
                >
        ...
        {activeTab === 'home' && (
          <div className="flex flex-col items-center justify-center min-h-[70vh] animate-fade-in px-4">
            <div className="max-w-4xl w-full text-center">
              <h1 className={`font-display text-6xl md:text-7xl font-bold mb-12 ${
              ...
              {/* Installation Command - Large centered block */}
              ...
              onClick={() => {
                navigator.clipboard.writeText('curl -fsSL https://raw.githubusercontent.com/ozacod/cpx/main/install.sh | bash');
              }}>
                <code className={`font-mono text-lg md:text-xl ${
                  ...
                  curl -fsSL https://raw.githubusercontent.com/ozacod/cpx/main/install.sh | bash
                </code>
